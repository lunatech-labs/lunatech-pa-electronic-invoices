...
/// Utilise un processeur XSLT 2.0 (SaxonC natif ou SaxonJ Java) et Apache FOP pour le rendu PDF.
...
impl FopEngine {
    ...
    /// Appelé une seule fois au new() pour éviter de recréer le fichier à chaque appel.
    ...
    /// Étape 3 : XSL-FO → PDF via Apache FOP.
