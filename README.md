...
| `pdp-cdar` | **CDV** : génération, parsing et routage CDAR D23B, statuts 200→212, `DocumentTypeRouter` | 108 |
...
- **CDV/CDAR** (D23B) — Compte-rendu De Vie
...
| [docs/cdar.md](docs/cdar.md) | CDV/CDAR D23B : routage entrant, sources (client/PDP/PPF), statuts 200→212 |
