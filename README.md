...
| Crate | Rôle | Tests |
|-------|------|-------|
| `pdp-core` | Modèle de données (`InvoiceData` EN16931), pipeline async, erreurs, archives ZIP/tar.gz, `ChannelConsumer`, `RetryProducer`, `DeadLetterProducer` | 86 |
...
**Total : 816 tests** (+ 8 tests ignorés pour génération de fixtures et FOP Java)
...
# Tests
cargo test --workspace    # 816 tests
